  ...
  return (
    <div className="common-hero lg:pt-[150px] lg:pb-[155px] md:pt-[120px] md:pb-[125px] pt-[100px] pb-[105px]">
      <div className="container-main flex flex-col items-center xl:items-start">
        <h1 className="sm:text-[42px] text-[34px] sm:font-[700] font-[600] text-white text-center xl:text-left">{pageName}</h1>
        <div className="flex items-center flex-wrap gap-[4px] sm:mt-[12px] mt-[6px]">
