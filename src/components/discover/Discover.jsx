        ...
        <div className='container-main flex flex-col lg:flex-row items-center lg:gap-[50px] sm:gap-[80px] gap-[100px]'>
            ...
            <div className='lg:w-[50%] relative flex items-center justify-end'>
                ...
                <div className='text-center bg-primary sm:py-[20px] py-[15px] absolute lg:left-[30px] sm:right-[-40px] right-[-10px] lg:top-[35px] bottom-[-55px] lg:bottom-auto z-[11] sm:w-[140px] max-w-[120px] px-[10px] rounded-[10px]'>
                    ...
                    <p className='text-white text-[14px] sm:font-[600] font-[300]'>Years of Experiences</p>
                </div>
            </div>
            {/* right  */}
            <div className='lg:w-[50%]'>
                ...
                <h2 className='sm:text-[38px] text-[28px] font-[700] text-secondary discover-title mt-[15px] mb-[12px]'>Discover Top <span className='text-primary'>Instructors</span> Around The World</h2>
                ...
                <div className='grid grid-cols-2 sm:gap-[35px] gap-[15px] mt-[35px] mb-[25px] max-w-[500px] lg:w-auto'>
                    ...
                    <div className='flex items-center gap-[8px]'>
                        ...
                        <div className='flex flex-col'>
                            <span className='text-secondary sm:font-[500] font-[400] sm:text-base text-[13px]'>20000</span>
                            <span className='text-secondary sm:font-[500] font-[400] sm:text-base text-[13px] leading-4'>Expert Tutors</span>
                        </div>
                    </div>
                    {/* item */}
                    <div className='flex items-center gap-[8px]'>
                        ...
                        <div className='flex flex-col'>
                            <span className='text-secondary sm:font-[500] font-[400] sm:text-base text-[13px]'>2500</span>
                            <span className='text-secondary sm:font-[500] font-[400] sm:text-base text-[13px] leading-4'>Top Lessons</span>
                        </div>
                    </div>
                    {/* item */}
                    <div className='flex items-center gap-[8px]'>
                        ...
                        <div className='flex flex-col'>
                            <span className='text-secondary sm:font-[500] font-[400] sm:text-base text-[13px]'>12000</span>
                            <span className='text-secondary sm:font-[500] font-[400] sm:text-base text-[13px] leading-4'>Over Students</span>
                        </div>
                    </div>
                    {/* item */}
                    <div className='flex items-center gap-[8px]'>
                        ...
                        <div className='flex flex-col'>
                            <span className='text-secondary sm:font-[500] font-[400] sm:text-base text-[13px]'>4600</span>
                            <span className='text-secondary sm:font-[500] font-[400] sm:text-base text-[13px] leading-4'>Pro Videos</span>
                        </div>
                    </div>
                </div>
